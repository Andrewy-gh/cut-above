...
## Phase 1: Foundation
- Setup pnpm workspace monorepo (shared schemas package, Dockerfile update, workspace deps)
...
- Fix security issues
  - CORS should not allow missing origin in prod
  - Client API base URL should use env (VITE_API_URL)
