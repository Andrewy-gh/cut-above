...
import { UserRole, AppointmentService, AppointmentStatus } from '../types/index.js';
...
export const users: SeedUser[] = [
  {
    ...
    passwordHash: bcrypt.hashSync('i2XKx4z31sFvWJmaA66k', 10),
    role: 'admin',
  },
  {
    firstName: 'First',
    ...
    passwordHash: bcrypt.hashSync('xUO0bSEGbOvns43wJGaq', 10),
    role: 'client',
  },
  {
    firstName: 'Second',
    ...
    passwordHash: bcrypt.hashSync('clFgbY347UiXfj69lJbk', 10),
    role: 'client',
  },
  {
    firstName: 'Third',
    ...
    passwordHash: bcrypt.hashSync('Vo4Fp1WAG4HT36KhtAd4', 10),
    role: 'client',
  },
  {
    firstName: 'Andre',
    ...
    passwordHash: bcrypt.hashSync('luUetSqtXcqDKvVkEDc2', 10),
    role: 'employee',
  ...
  },
  {
    ...
    passwordHash: bcrypt.hashSync('kgkt6PQQTq5SKLkO7QPO!', 10),
    role: 'employee',
    // image: insert image url
    profile:
  ...
  // Additional clients
  {
    ...
    passwordHash: bcrypt.hashSync('xFBKwZp7r9PMyaMc9ag5', 10),
    role: 'client',
  },
  {
    firstName: 'Emily',
    ...
    passwordHash: bcrypt.hashSync('exA2HPygLTfWw2XQifC5', 10),
    role: 'client',
  },
  {
    firstName: 'Michael',
    ...
    passwordHash: bcrypt.hashSync('UEZDrSPWs6wa6mj2DXmX', 10),
    role: 'client',
  },
  {
    firstName: 'Sarah',
    ...
    passwordHash: bcrypt.hashSync('x5yfYyN2Mit3bSoMAt6q', 10),
    role: 'client',
  },
  {
    firstName: 'David',
    ...
    passwordHash: bcrypt.hashSync('8x6ZBlZLb76tBYqBSSTC', 10),
    role: 'client',
  },
];
